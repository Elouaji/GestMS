				...
				<div id="content" class="content-wrapper pb-0">
					...
					<div class="row">
						<div class="col-12 grid-margin stretch-card mt-0">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title text-center">Chercher une machine</h4>
									<div class="row">
									<div class="form-group col-12 mx-auto">
										...
										<div class="text-center col-6 m-auto">
											<button type="button" class="btn btn-success btn-block enter-btn" onclick="ChercherMachine()">Rechercher</button>
										</div>
									</div>	
								</div>
							</div>
						...
						<div class="col-lg-12 grid-margin stretch-card mt-0">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">Liste des machines entre deux dates</h4>
...
function ChercherMachine(){
	var idSalle = $("#salle").val();
	console.log(idSalle);
	$.ajax({
		url: "MachineController",
		data: { op: "findMachines",
			    idSalle: idSalle
			    },
		type: 'POST',
		success: function(data, textStatus, jqXHR) {
